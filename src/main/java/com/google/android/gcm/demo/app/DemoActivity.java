...
public class DemoActivity extends Activity {
    ...
    private boolean registerToUniqush(String registrationId) throws IOException {
        RequestBody formBody = new FormEncodingBuilder()
                    .add("service", "ZenUI_PushService_5")
                    .add("subscriber", "uniqush.client")
                    .add("pushservicetype", "gcm")
                    .add("regid", registrationId)
                    .build();
    ...
    private boolean registerToPushd(String registrationId) throws IOException {
        ...
        if (response.isSuccessful()) {
            ...
            //subscriber
            RequestBody subscriberFormBody = new FormEncodingBuilder()
